...
public:
	...
	// ------------------------------------------------------------------------
	Shader(const char* vertexPath, const char* fragmentPath = nullptr, const char* geometryPath = nullptr, const char* tesseControlPath = nullptr, const char* tesseEvalPath = nullptr)
	{
		...
		try
		{
			...
			if (tesseControlPath != nullptr)
			{
				tcShaderFile.open(tesseControlPath);
				std::stringstream tcShaderStream;
				tcShaderStream << tcShaderFile.rdbuf();
				tcShaderFile.close();
				tesseControlCode = tcShaderStream.str();
			}
			if (tesseEvalPath != nullptr)
			{
				teShaderFile.open(tesseEvalPath);
				std::stringstream teShaderStream;
				teShaderStream << teShaderFile.rdbuf();
				teShaderFile.close();
				tesseEvalCode = teShaderStream.str();
			}
		}
		...
		if (tesseControlPath != nullptr)
		{
			...
			checkCompileErrors(tesselationControl, "TESSELATION CONTROL");
		}
		if (tesseEvalPath != nullptr)
		{
			...
			checkCompileErrors(tesselationEvaluation, "TESSELATION EVALUATION");
		}
